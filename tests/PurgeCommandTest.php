...
class PurgeCommandTest extends TestCase
{
    ...
    public function it_accepts_an_existing_zone()
    {
        ...
        $this->artisan('cloudflare:purge-cache', ['zone' => 'another-identifier']);
    ...
    public function it_accepts_a_custom_zone()
    {
        ...
        $this->artisan('cloudflare:purge-cache', ['zone' => 'my-zone']);
    ...
    public function it_accepts_files()
    {
        ...
        $this->artisan('cloudflare:purge-cache', ['--file' => $files]);
    ...
    public function it_accepts_tags()
    {
        ...
        $this->artisan('cloudflare:purge-cache', ['--tag' => $tags]);
    ...
    public function it_accepts_hosts()
    {
        ...
        $this->artisan('cloudflare:purge-cache', ['--host' => $hosts]);
